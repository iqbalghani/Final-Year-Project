...
if(isset($_POST['login']))
    {
        ...
        $check_user="SELECT * FROM tbmembers WHERE email='$user_name' and password='$user_pass'";
        ...
        if(mysqli_num_rows($run))
        {
            ...
            $_SESSION['member_id'] = $user['member_id'];//here session is used and value of $user_email store in $_SESSION.
...
<body class="login-img3-body">
  ...
  <div class="container">
    ...
    <form class="login-form" method="post" action="" onSubmit="return loginValidate(this)">
      <div class="login-wrap">
        ...
        <div class="input-group">
          ...
          <input name="myusername" type="text" class="form-control" placeholder="Username/Email" autofocus>
        </div>
        <div class="input-group">

...
<?php
    ...
    $sql = mysqli_query($con, "UPDATE tbAdministrators SET first_name='$emyFirstName', last_name='$emyLastName', email='$myEmail' WHERE admin_id = '$myId'" );
    if($sql)
     {
     // get data from db
     $result=mysqli_query($con, "SELECT * FROM tbadministrators WHERE admin_id = '$_SESSION[admin_id]'");
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-gear"></i> Manage Account</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="admin.php">Home</a></li>
              <li><i class="fa fa-gear"></i>Manage Account</li>
            </ol>
          </div>
        </div>

...
?>
    ...
    $query = "SELECT *
         FROM tbmembers WHERE member_id='$id'";
    $result = mysqli_query($con, $query) or die('SQL error student');
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h5 class="h1 text-center">Hi student, <?php echo decryptthis($row['first_name'], $key); ?>! </h5>
